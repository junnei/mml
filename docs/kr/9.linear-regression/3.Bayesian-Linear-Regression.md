...
위 식 (4) 에서 $\phi^T(x_*)S_0\phi(x_*)$ 텀은 파라미터 $\theta$의 불확실성으로부터 비롯된 예측 variance를 의미하며, $\sigma^2$ 텀은 measurement noise의 불확실성으로부터 비롯된 variance를 의미한다. 
...
>
>{: .no_toc .text-delta }
<img src="{{ site.figure | absolute_url }}9.3.2.png" width="800px"/>
...
>
>{: .no_toc .text-delta }
<img src="{{ site.figure | absolute_url }}9.3.4.png" width="800px"/>
> 
...
>
>{: .no_toc .text-delta }
<img src="{{ site.figure | absolute_url }}9.3.4_2.png" width="800px"/>
> 
