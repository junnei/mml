...
<div style="text-align:right;"> Writer : {{ site.data.writers[page.writer][page.lang].name }} *{{ page.writer }}* <a href="{{ contributor.html_url }}"><img style="vertical-align:middle;" src="{{ contributor.avatar_url }}" width="32" height="32" alt="{{ contributor.login }}"/></a>
</div>
{% endif %}
{% endfor %}
---
